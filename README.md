...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ql09ieg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ql09ieg.containers.anotherwebservice.com/
...
```
git clone git@github.com:Irycx/container-ql09ieg.git
cd container-ql09ieg
```
...
```
docker attach container-ql09ieg
```
